                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('app/<?php echo $user['avatar']; ?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                <!-- профил -->
                                <a href="app/profil.php?id=<?php echo $user['id']; ?>" class="fs-xl text-truncate text-truncate-lg text-info">
                                    <?php echo $user['name']; ?>
                                </a>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="app/edit.php?id=<?php echo $user['id']; ?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="app/security.php?id=<?php echo $user['id']; ?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="app/edit_status.php?id=<?php echo $user['id']; ?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="app/edit_avatar.php?id=<?php echo $user['id']; ?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="app/delete_user.php?id=<?php echo $user['id']; ?>&path_avatar=<?php echo $user['avatar']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                            <i class="fa fa-window-close"></i>
                                            Удалить
                                        </a>
                                    </div>
                                    <span class="text-truncate text-truncate-xl"><?php echo $user['address_job']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <a href="instagram" class="mr-2 fs-xxl" style="color:#E1306C">
