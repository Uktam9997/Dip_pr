...
if(empty($_SESSION['user'])) {
    $_SESSION['error'] = 'повтарите попитку';
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <?php if($user): ?>
        <form enctype="multipart/form-data" action="app/uploads_avatar.php?id=<?php echo $user['id']; ?>&path_img=<?php echo $user['avatar']; ?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="app/<?php echo $user['avatar']; ?>" alt="" class="img-responsive" width="200">
                                </div>
