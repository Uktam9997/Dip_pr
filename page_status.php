...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <?php if($user): ?>
        <form action="app/update_status.php?id=<?php echo $user['id']?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="example-select">
                                                <option value="online" <?php echo $user['status'] == 'online' ? 'selected' : '';?>>Онлайн</option>
                                                <option value="away" <?php echo $user['status'] == 'away' ? 'selected' : '';?>>Отошел</option>
                                                <option value="busy" <?php echo $user['status'] == 'busy' ? 'selected' : '';?>>Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>
